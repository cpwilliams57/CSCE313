...
void process_data_request (FIFORequestChannel* rc, char* request){
    ...
    //writes data back to the request channel
...
{
    //infinite loop
    //casting channel as a request channel pointer
...
int main(int argc, char *argv[])
{
    ...
    //server side control channel created
    //Gives info to client
	FIFORequestChannel control_channel("control", FIFORequestChannel::SERVER_SIDE);
    
    //Passing control channel to infinite process loop
